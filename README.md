# 🙇‍♀️ 안녕하세요, '그냥 하는' 개발자 김재희입니다.

> **"중요한 것은 꺾여도 그냥 하는 마음"** <br>
> 에러에 부딪혀도 멈추지 않고, 문제를 끝까지 파고들어 해결해내는 끈기를 가졌습니다.
...
|:---:|:---|:---|
| 2024.10.07 ~ 2025.04.07 | **플레이데이터 풀스택 백엔드 개발자 양성 과정** | KDT - Full Stack Backend Developer Course |
| 2020.03 ~  | 경기대학교 컴퓨터공학전공 | 재학 중 |
<br>
...
| PERIOD | TITLE | SUBJECT |
|:---:|:---|:---|
| 2025.11 ~ 2026.01 | **[justaday](https://github.com/jahee24/justaday)** 🔗 | **AI 감정 분석 다이어리 (Android/iOS/Backend/Infra)** <br> - Google Gemini API 기반 비동기 감정 분석 및 페르소나 피드백 <br> - 프롬프트 엔지니어링 및 [OneStore 출시](https://m.onestore.co.kr/v2/ko-kr/app/0001003418) <br> - **Spring AI, PostgreSQL, Docker, Jenkins 사용** |
| 2024.12 ~ 2025.02 | **[Mimi 시리즈](https://github.com/jahee24/mimigate)** 🔗 | **MSA 학습 프로젝트** <br> - Eureka Server를 이용한 서비스 디스커버리 및 로드밸런싱 <br> - Spring Cloud Gateway를 통한 API 게이트웨이 구축 <br> - **Spring Boot 3.4.0, Gateway, Eureka Client 사용** |
| 2024.03 ~ 2024.07 | **[InsaHi](https://github.com/jahee24/InsaHi)** 🔗 | **기업 인사 관리 시스템 (MSA)** <br> - Jenkins & ArgoCD 활용 GitOps CI/CD 파이프라인 구축 <br> - AWS EC2 & S3를 활용한 인프라 및 파일 저장소 구축 <br> - SSE 기반 실시간 알림 및 Feign Client 통신 |
| 2024.10 ~ 2024.12 | **[Project_Mung_mini](https://github.com/jahee24/Project_Mung_mini)** 🔗 | **반려견 산책/예약 서비스** <br> - Spring Boot + MyBatis + JSP 기반 풀스택 구현 <br> - 도메인 기반 패키지 구조 설계 및 세션 기반 인증 관리 <br> - 예약 시스템 트랜잭션 처리 |
...
<div align="center">
  <img src="https://github-readme-stats-three-pi-26.vercel.app/api?username=jahee24&count_private=true&show_icons=true&count_private=true" alt="GitHub stats"/>
</div>
